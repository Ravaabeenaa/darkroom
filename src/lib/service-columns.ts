...
export const SERVICE_COLUMNS: ServiceColDef[] = [
  ...
  { key: "turnaround_options",     type: "text" },
  { key: "turnaround_prices",      type: "text" },
  { key: "pushpull_options",       type: "text" },
  { key: "pushpull_prices",        type: "text" },
  { key: "film_size_options",      type: "text" },
  { key: "film_size_prices",       type: "text" },
  { key: "collection_options",     type: "text" },
  { key: "collection_prices",      type: "text" },
